...
public class SPQRNodeManagerTest {
	...
	public void testRegisterNode_withEmptyProtocol() {
		Assert.assertEquals("Invalid input", NodeRegistrationState.MISSING_PROTOCOL, new SPQRNodeManager(5).registerNode("", "localhost", 8080, 9090).getState());
	}
	...
	public void testRegisterNode_withEmptyRemoteHost() {
		Assert.assertEquals("Invalid input", NodeRegistrationState.MISSING_HOST, new SPQRNodeManager(5).registerNode("http", "", 8080, 9090).getState());
	}
	...
	public void testRegisterNode_withInvalidServicePort() {
		Assert.assertEquals("Invalid input", NodeRegistrationState.MISSING_SERVICE_PORT, new SPQRNodeManager(5).registerNode("http", "localhost", -1, 9090).getState());
	}
	...
	public void testRegisterNode_withInvalidAdminPort() {
		Assert.assertEquals("Invalid input", NodeRegistrationState.MISSING_ADMIN_PORT, new SPQRNodeManager(5).registerNode("http", "localhost", 8080, -1).getState());
	}
	...
	public void testRegisterNode_withFailedNodeIdComputation() {
		Assert.assertEquals("Invalid input", NodeRegistrationState.NODE_ID_COMPUTATION_FAILED, new SPQRNodeManager(0).registerNode("http", "localhost", 8080, 9090).getState());
	}
	...
	public void testRegisterNode_withValidInput() {		
		SPQRNodeManager manager = new SPQRNodeManager(5);
	...
	public void testDeRegisterNode_withEmptyInput() {
		Assert.assertEquals("Invalid input", NodeDeRegistrationState.MISSING_NODE_ID, new SPQRNodeManager(5).deregisterNode("").getState());
	}
	...
	public void testDeRegisterNode_withUnknownNodeId() {
		Assert.assertEquals("Invalid input", NodeDeRegistrationState.NO_SUCH_NODE_ID, new SPQRNodeManager(5).deregisterNode("unknown-id").getState());
	}
