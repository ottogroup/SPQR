...
public class SPQRNodeClient {
	...
	public MicroPipelineInstantiationResponse instantiatePipeline(final MicroPipelineConfiguration pipelineConfiguration) 
		...
		try {
			WebResource pipelineInstantiationResource = restClient.resource(url.toString());
...
//		// TODO validate pipeline to avoid sending it to remote instances
//		//
//		///////////////////////////////////////////////////////
//		
//
//		String message = jsonMapper.writeValueAsString(new MicroPipelineInstantiationRequest(pipelineConfiguration)); 
//		StringBuffer url = new StringBuffer(this.processingNodeServiceBaseUrl).append("/pipelines/").append(pipelineConfiguration.getId());
//		
//		if(logger.isDebugEnabled()) 
...
//		
//		try {
//			WebResource pipelineInstantiationResource = client.resource(url.toString());
