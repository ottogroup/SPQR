 ...
 *
 */
public class SPQRGraphiteReporter extends ScheduledReporter {
    /**
    ...
    public static class Builder {
         ...
         */
        public SPQRGraphiteReporter build(Graphite graphite) {
         ...
         * @return a {@link GraphiteReporter}
         */
        public SPQRGraphiteReporter build(GraphiteSender graphite) {
            return new SPQRGraphiteReporter(registry,
                                        graphite,
                                        clock,
                                        prefix,
                                        rateUnit,
    ...
    private SPQRGraphiteReporter(MetricRegistry registry,
