 ...
 * @since Apr 20, 2015
 */
public class StreamingMessageQueueBlockingWaitStrategy implements StreamingMessageQueueWaitStrategy {
	
	public static final String STRATEGY_NAME = "blockingWait";
